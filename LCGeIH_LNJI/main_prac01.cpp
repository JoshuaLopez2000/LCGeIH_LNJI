...
int main()
{
	...
	glfwSetWindowPos(window, 0, 30); //configuración de la posición de la ventana
	glfwMakeContextCurrent(window);	//función que despliega la ventana una vez terminada la configuración
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//glDrawArrays(GL_LINE_STRIP, 0, 6); //Genera segmentos de linea uno detrás de otro, no es necesario que sean pares
		//-----------------------------------------------
		...
		*/
		...
		// necesario aumentar el tamaño de elementos, evita duplicar vertices
