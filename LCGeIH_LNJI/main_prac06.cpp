...
//Camera
Camera camera(glm::vec3(0.0f, 0.0f, 3.0f)); //se accede a la clase camara y se crea el objeto camara proporcionando los parametros xyza
											//vector de vista asociado al movimiento del mouse 
...
//Texture | Declaramos una variable por cada textura
...
void LoadTextures()
{
	t_cube = generateTextures("Texturas/Cube03.jpg", 0, true);
	t_calabazas = generateTextures("Texturas/calabazas.png", 1, true);
	t_paredA = generateTextures("Texturas/paredA.jpg", 0, true); //parametros adicionales (canal alpha, primitivas T o modelos F)
...
void myData() {
	float vertices[] = {
		// positions          // texture coords | Repetición de texturas 
	...
	GLfloat verticesCubo[] = {
		...
		0.5f, -0.5f, -0.5f,		0.75f, 0.333f,	//V2 - Trasera
		-0.5f, -0.5f, -0.5f,	1.0f, 0.333f,	//V3
		-0.5f, 0.5f, -0.5f,		1.0f, 0.666f,	//V7
		0.5f, -0.5f, -0.5f,		0.75f, 0.333f,	//V2
		0.5f, 0.5f, -0.5f,		0.75f, 0.666f,	//V6
		-0.5f, 0.5f, -0.5f,		1.0f, 0.666,	//V7

		-0.5f, 0.5f, 0.5f,		0.25f, 0.666f,	//V4 - Izq
		-0.5f, 0.5f, -0.5f,		0.0f, 0.666,	//V7
		-0.5f, -0.5f, -0.5f,	0.0f, 0.333f,	//V3
		-0.5f, -0.5f, -0.5f,	0.0f, 0.333f,	//V3
		-0.5f, 0.5f, 0.5f,		0.25f, 0.666f,	//V4
		-0.5f, -0.5f, 0.5f,		0.25f, 0.333f,	//V0

		0.5f, 0.5f, 0.5f,		0.5f, 0.666f,	//V5 - Der
		0.5f, -0.5f, 0.5f,		0.5f, 0.333f,	//V1
		0.5f, -0.5f, -0.5f,		0.75f, 0.333f,	//V2
		0.5f, 0.5f, 0.5f,		0.5f, 0.666f,	//V5
		0.5f, 0.5f, -0.5f,		0.75f, 0.666f,	//V6
		...
		-0.5f, -0.5f, 0.5f,		0.25f, 0.333f,	//V0 - Inf
...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		myShader.setMat4("model", modelOp);
		myShader.setVec3("aColor", 1.0f, 1.0f, 1.0f);
		glBindTexture(GL_TEXTURE_2D, t_calabazas); // a partir de ese momento ocupa la textura asignada 
		...
		myShader.setMat4("model", modelOp);
		myShader.setVec3("aColor", 1.0f, 1.0f, 1.0f); // el resultado final es una multiplicación del color asignado y la textura
